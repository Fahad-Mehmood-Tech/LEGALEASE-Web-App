        ...
        <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
            <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-8">
                ...
                <p className="text-center text-gray-500 text-sm mt-6">
                    ...
                    <Link to="/lawyer/register" className="text-blue-600 font-medium hover:underline">
                        Register here
                    </Link>
                </p>
                ...
                <div className="mt-6 bg-blue-50 rounded-lg p-3 text-sm text-gray-600">
                    ...
                    <p>Email: <span className="font-medium">ahmed@legalease.com</span></p>
                    <p>Password: <span className="font-medium">lawyer123</span></p>
                </div>
